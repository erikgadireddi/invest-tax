...
st.caption('* splity se importují a aplikují')
st.caption('* stažené csv persistuje obchody i korporátní akce')
st.caption('* lze vidět nespárovatelné obchody')
st.caption('* reportují se negativní pozice způsobené absencí dat')
