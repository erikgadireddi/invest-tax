    ...
    for year in years:
        ...
        trades_display = st.dataframe(sell_buy_pairs[sell_buy_pairs['Sell Time'].dt.year == show_year], hide_index=True, height=600, 
                                    ...
                                    column_config={
                                        ...
                                        'Buy Cost': st.column_config.NumberColumn("Nákup (čistý)", help="Cena nákupu 1 kusu včetně poplatků", format="%.1f"), 
                                        'Sell Proceeds': st.column_config.NumberColumn("Prodej (čistý)", help="Cena prodeje 1 kusu včetně poplatků", format="%.1f"), 
