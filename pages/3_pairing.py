    ...
    for year in years:
        ...
        trades_display = st.dataframe(sell_buy_pairs[sell_buy_pairs['Sell Time'].dt.year == show_year], hide_index=True, height=600, 
                                    ...
                                    column_config={
                                        ...
                                        'Buy Price': st.column_config.NumberColumn("Nákup", help="Cena nákupu 1 kusu bez poplatků", format="%.2f"), 
                                        'Sell Price': st.column_config.NumberColumn("Prodej", help="Cena prodeje 1 kusu bez poplatků", format="%.2f"), 
                                        'Buy Cost': st.column_config.NumberColumn("Prům. nákup", help="Cena nákupu 1 kusu včetně poplatků", format="%.1f"), 
                                        'Sell Proceeds': st.column_config.NumberColumn("Prům. prodej", help="Cena prodeje 1 kusu včetně poplatků", format="%.1f"), 
                                        'Revenue': st.column_config.NumberColumn("Výdělek", help="Zisk z prodeje mínus cena nákupu včetně poplatků", format="%.1f"), 
